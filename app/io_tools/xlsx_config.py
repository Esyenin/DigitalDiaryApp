"""
Конфигурация структуры XLSX-файлов для импорта и экспорта.
"""
...
def normalize_sheet_keys(
    ...
    """
    Приводит имена моделей и листов к каноническим ключам XLSX.

    :param model_names: Список пользовательских имен моделей или `None`, если нужно
        использовать все поддерживаемые сущности.
    :return: Кортеж канонических ключей листов XLSX в согласованном порядке.
    :raises ValueError: Если хотя бы одно имя модели не поддерживается.
    """
