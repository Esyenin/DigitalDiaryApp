...
def test_services_db_flow(db_session):
    ...
    db_attendance = db_session.scalar(attendance_service.build_select({"student_id": student.id}))
    db_mark = db_session.scalar(mark_service.build_select({"student_id": student.id}))
    db_comment = db_session.scalar(comment_service.build_select({"student_id": student.id}))
